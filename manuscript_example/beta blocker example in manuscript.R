...
# random effect by specify the prob.random effect= 1#
set.seed(4325435)
ex4.rdm.subgrp<- bayesian.mdl.uncertainty.meta.analysis.subgrp(y= as.numeric(eff.summary$yi), 
                                                               var_y= as.numeric(eff.summary$vi), 
                                                               subgrp= ifelse(eff.summary$subgrp=="AF", 1, 2),
                                                               parms.ini= parms.ini, 
                                                               mu_beta= rep(0, 2), 
...
gelman.diag(ex4.rdm.subgrp) 
autocorr.plot(ex4.rdm.subgrp)
HPDinterval(ex4.rdm.subgrp)
summary(ex4.rdm.subgrp[, c("or1", "or2", "or.subgrp", "fixed.effect1", "fixed.effect2", "sd.random1", "sd.random2")])
plot(ex4.rdm.subgrp[, c("or1", "or2", "or.subgrp", "fixed.effect1", "fixed.effect2", "sd.random1", "sd.random2")])
autocorr.plot(ex4.rdm.subgrp[, c("or1", "or2", "or.subgrp", "fixed.effect1", "fixed.effect2", "sd.random1", "sd.random2")])
HPDinterval(ex4.rdm.subgrp[, c("or1", "or2", "or.subgrp", "fixed.effect1", "fixed.effect2", "sd.random1", "sd.random2")])


par(mfcol= c(3, 1))
plot(density(unlist(ex4.rdm.subgrp[, c("or2")])), main= "Treatment effect in HF patients with SR", xlim= c(0, 1.5), xlab= "Odds ratio")
#      abline(v= mean(unlist(ex4.subgrp[, c("or2")])), lwd= 2)
plot(density(unlist(ex4.rdm.subgrp[, c("or1")])), main= "Treatment effect in HF patients with AF", xlim= c(0, 1.5), xlab= "Odds ratio")
#      abline(v= mean(unlist(ex4.subgrp[, c("or1")])), lwd= 2)
plot(density(unlist(ex4.rdm.subgrp[, c("or.subgrp")])), main= "Differential treatment effect (SR vs. AF)", xlim= c(0, 1.5), xlab= "Odds ratio")
#      abline(v= mean(unlist(ex4.subgrp[, c("or.subgrp")])), lwd= 2)

plot(density(unlist(ex4.rdm.subgrp[, c("beta2")])), main= "Treatment effect in HF patients with SR", xlab= "Odds ratio")
#      abline(v= mean(unlist(ex4.subgrp[, c("or2")])), lwd= 2)
plot(density(unlist(ex4.rdm.subgrp[, c("beta1")])), main= "Treatment effect in HF patients with AF", xlab= "Odds ratio")
#      abline(v= mean(unlist(ex4.subgrp[, c("or1")])), lwd= 2)
plot(density(unlist(ex4.rdm.subgrp[, c("or.subgrp")])), main= "Differential treatment effect (SR vs. AF)", xlab= "Odds ratio")
#      abline(v= mean(unlist(ex4.subgrp[, c("or.subgrp")])), lwd= 2)

# SR subgroup (= 2)
# Bayes factor
mean(unlist(ex4.rdm.subgrp[, c("fixed.effect2")])>0)/(1-mean(unlist(ex4.rdm.subgrp[, c("fixed.effect2")])>0))
mean(unlist(ex4.rdm.subgrp[, c("fixed.effect1")])>0)/(1-mean(unlist(ex4.rdm.subgrp[, c("fixed.effect1")])>0))




# fixed effect by specify the prob.random effect= 0#
set.seed(4325435)
ex4.fix.subgrp<- bayesian.mdl.uncertainty.meta.analysis.subgrp(y= as.numeric(eff.summary$yi), 
                                                               var_y= as.numeric(eff.summary$vi), 
                                                               subgrp= ifelse(eff.summary$subgrp=="AF", 1, 2),
                                                               parms.ini= parms.ini, 
                                                               mu_beta= rep(0, 2), 
...
gelman.diag(ex4.fix.subgrp[, c("or1", "or2", "or.subgrp")]) 
autocorr.plot(ex4.fix.subgrp)
HPDinterval(ex4.fix.subgrp)
summary(ex4.fix.subgrp[, c("or1", "or2", "or.subgrp", "fixed.effect1", "fixed.effect2", "sd.random1", "sd.random2")])
plot(ex4.fix.subgrp[, c("or1", "or2", "or.subgrp", "fixed.effect1", "fixed.effect2", "sd.random1", "sd.random2")])
autocorr.plot(ex4.fix.subgrp[, c("or1", "or2", "or.subgrp", "fixed.effect1", "fixed.effect2", "sd.random1", "sd.random2")])
HPDinterval(ex4.fix.subgrp[, c("or1", "or2", "or.subgrp", "fixed.effect1", "fixed.effect2", "sd.random1", "sd.random2")])[[1]]


par(mfcol= c(3, 1))
plot(density(unlist(ex4.fix.subgrp[, c("beta2")])), main= "Treatment effect in HF patients with SR", xlab= "Odds ratio")
#      abline(v= mean(unlist(ex4.subgrp[, c("or2")])), lwd= 2)
plot(density(unlist(ex4.fix.subgrp[, c("beta1")])), main= "Treatment effect in HF patients with AF", xlab= "Odds ratio")
#      abline(v= mean(unlist(ex4.subgrp[, c("or1")])), lwd= 2)
plot(density(unlist(ex4.fix.subgrp[, c("or.subgrp")])), main= "Differential treatment effect (SR vs. AF)", xlim= c(0, 1.5), xlab= "Odds ratio")
#      abline(v= mean(unlist(ex4.subgrp[, c("or.subgrp")])), lwd= 2)

# SR subgroup (= 2)
# Bayes factor
mean(unlist(ex4.fix.subgrp[, c("fixed.effect2")])>0)/(1-mean(unlist(ex4.rdm.subgrp[, c("fixed.effect2")])>0))
mean(unlist(ex4.fix.subgrp[, c("fixed.effect1")])>0)/(1-mean(unlist(ex4.rdm.subgrp[, c("fixed.effect1")])>0))




summary(ex4.subgrp[, c("beta1", "beta2", "diff.subgrp", "fixed.effect1", "fixed.effect2")])$statistics
HPDinterval(ex4.subgrp[, c("beta1", "beta2", "diff.subgrp", "fixed.effect1", "fixed.effect2")])[[1]]

summary(ex4.fix.subgrp[, c("beta1", "beta2", "diff.subgrp", "fixed.effect1", "fixed.effect2")])$statistics
HPDinterval(ex4.fix.subgrp[, c("beta1", "beta2", "diff.subgrp", "fixed.effect1", "fixed.effect2")])[[1]]

summary(ex4.rdm.subgrp[, c("beta1", "beta2", "diff.subgrp", "fixed.effect1", "fixed.effect2")])$statistics
HPDinterval(ex4.rdm.subgrp[, c("beta1", "beta2", "diff.subgrp", "fixed.effect1", "fixed.effect2")])[[1]]



save.image("beta_blocker_ex.RData")
